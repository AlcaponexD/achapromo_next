...
const Pagination = ({ totalPages, currentPage, onPageChange }) => {
    ...
    const displayPageNumbers = () => {
        ...
        if (startPage > 1) {
            pages.push(
                <li key="1" className="min-w-[2.5rem] h-10 flex items-center justify-center px-3 rounded-md text-sm font-medium cursor-pointer transition-all duration-200 border border-gray-300 dark:border-gray-600 hover:bg-light-primary dark:hover:bg-dark-primary hover:text-white hover:scale-110 active:scale-95 hover:border-transparent dark:text-gray-200">
                    1
                </li>
            );
            if (startPage > 2) {
                pages.push(<li key="ellipsis1" className="min-w-[2.5rem] h-10 flex items-center justify-center text-gray-500 dark:text-gray-400 cursor-default">...</li>);
            }
        }
        ...
        if (endPage < totalPages) {
            if (endPage < totalPages - 1) {
                pages.push(<li key="ellipsis2" className="min-w-[2.5rem] h-10 flex items-center justify-center text-gray-500 dark:text-gray-400 cursor-default">...</li>);
            }
            pages.push(
                <li
                    key={totalPages}
