          ...
          <div className="flex flex-col p-3 text-center content-center space-y-4">
            ...
            <div className="w-[200px]">
              <a
                ...
                className={`text-sm md:text-base rounded-lg p-3 px-8 text-white transition-colors duration-200 inline-block w-full ${isExpired
                    ? 'bg-gray-500 hover:bg-gray-600'
                    : 'bg-light-primary hover:bg-light-secondary'
                  }`}
              >
                {isExpired ? 'Oferta expirada' : 'Pegar promo'}
              </a>
            </div>
